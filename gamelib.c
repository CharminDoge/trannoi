...
// c'è un problema con la randomizzazione dei turni, randomizzi, ma poi non usi l'ordine e questa funzione qua sotto, nell0ultimo printf, non stampa il colore in base all'array randomizzato
